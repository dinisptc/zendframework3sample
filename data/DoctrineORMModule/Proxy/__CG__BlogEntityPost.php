...
class Post extends \Blog\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'title', 'content', 'status', 'dateCreated', 'comments', 'tags', 'identidade'];
        }
    ...
    public function setIdentidade($identidade)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdentidade', [$identidade]);

        return parent::setIdentidade($identidade);
    }
